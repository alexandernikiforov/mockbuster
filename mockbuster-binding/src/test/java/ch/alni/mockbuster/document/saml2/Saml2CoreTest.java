...
import ch.alni.mockbuster.document.saml2.config.Saml2CoreConfig;

import static org.fest.assertions.Assertions.assertThat;

public class Saml2CoreTest {

    private Saml2Core saml2Core;
    ...
    public void setUp() throws Exception {
        ...
        saml2Core = new Saml2Core(jaxbContext, schema);
    }
    ...
    public void testSerialize() throws Exception {
        ...
        AuthnRequestType authnRequest = saml2Core.documentToObject(document, AuthnRequestType.class);
        ...
        Documents.toWriter(saml2Core.objectToDocument(jaxbElement), writer);
