...
import ch.alni.mockbuster.document.saml2.Saml2Core;

@Configuration
@ComponentScan(basePackageClasses = {Saml2Core.class})
public class Saml2CoreConfig {
    ...
    @Bean
    public Saml2Core saml2Serializer() {
        return new Saml2Core(jaxbContext(), schema());
    }
}
