...
/**
 * Authentication request containing parsed SAML request object that could not be validated and will be denied.
 */
public class DeniedAuthnRequest implements SamlRequest {
    private final ServiceRequest serviceRequest;
    private final AuthnRequestType authnRequestType;
    private final SamlResponseStatus samlResponseStatus;

    public DeniedAuthnRequest(ServiceRequest request, AuthnRequestType authnRequestType, SamlResponseStatus samlResponseStatus) {
