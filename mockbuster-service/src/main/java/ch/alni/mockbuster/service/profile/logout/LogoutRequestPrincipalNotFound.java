...
public class LogoutRequestPrincipalNotFound implements ServiceEvent {
    private final LogoutRequestType logoutRequestType;
    private final ServiceResponse serviceResponse;

    public LogoutRequestPrincipalNotFound(LogoutRequestType logoutRequestType, ServiceResponse serviceResponse) {
