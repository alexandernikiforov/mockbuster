...
public class SamlRequestValidated<T extends RequestAbstractType> implements ServiceEvent {
    private final ServiceRequest serviceRequest;
    private final ServiceResponse serviceResponse;
    private final T samlRequestType;

    protected SamlRequestValidated(ServiceRequest serviceRequest, ServiceResponse serviceResponse, T samlRequestType) {
