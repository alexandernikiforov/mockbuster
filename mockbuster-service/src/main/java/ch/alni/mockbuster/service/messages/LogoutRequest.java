...
/**
 * Logout request containing parsed SAML request object.
 */
public class LogoutRequest implements SamlRequest {
    private final ServiceRequest request;
    private final LogoutRequestType logoutRequestType;
    private final ServiceProvider serviceProvider;
    private final IdentityProvider identityProvider;

    protected LogoutRequest(ServiceRequest request, LogoutRequestType logoutRequestType, ServiceProvider serviceProvider, IdentityProvider identityProvider) {
