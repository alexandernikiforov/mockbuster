...
public class SamlRequestParsed<T extends RequestAbstractType> implements ServiceEvent {
    private final ServiceRequest serviceRequest;
    private final ServiceResponse serviceResponse;
    private final T samlRequestType;

    protected SamlRequestParsed(ServiceRequest serviceRequest, ServiceResponse serviceResponse, T samlRequestType) {
