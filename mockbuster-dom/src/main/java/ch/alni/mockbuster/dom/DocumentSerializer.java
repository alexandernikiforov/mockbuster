...
public class DocumentSerializer {
    ...
    public DocumentSerializer(JAXBContext jaxbContext, Schema schema) {
        this.jaxbContext = jaxbContext;
        this.schema = schema;
    }

    public <T> T documentToObject(Document document, Class<T> clazz) {
        try {
    ...
    public Document objectToDocument(JAXBElement<?> samlObject) {
        try {
